...
RcppExport SEXP _PCSF2_call_sr(SEXP fromSEXP, SEXP toSEXP, SEXP costSEXP, SEXP node_namesSEXP, SEXP node_prizesSEXP) {
BEGIN_RCPP
...
static const R_CallMethodDef CallEntries[] = {
    {"_PCSF2_call_sr", (DL_FUNC) &_PCSF2_call_sr, 5},
    {NULL, NULL, 0}
};

RcppExport void R_init_PCSF2(DllInfo *dll) {
